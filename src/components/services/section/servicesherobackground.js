...
export default function ServicesHeroBackground() {
    ...
    let ctx = gsap.context(() => {
      ...
      gsap.fromTo(
        ...
        },
        {
          ...
          scrollTrigger: {
            trigger: '.services-hero',
            start: 'top+=600px bottom-=700px',
            end: 'bottom+=100px top-=200px',
            scrub: true,
            //markers: true,
  ...
  return (
   <>
   <Image src="/media/images/services-bg.jpg" width={3000} height={2000} quality={100} alt="Background image" className="homepage-bg-lines absolute z-0 left-0 right-0 top-0 h-full min-w-max"/>
