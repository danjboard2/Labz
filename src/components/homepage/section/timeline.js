      ...
      <section className="company-timeline one" id="company-timeline">
          <div className="contain">
            ...
            <div className="timeline-heading overflow-x-clip">
                  <h2 className="year-2021 lg:text-[350px] xl:text-[550px] xxl:text-[674px] leading-[1] ml-[1000px] text-white -mb-[450px] font-extrabold">2021</h2>
                  <h4 className="roadmap lg:left-[310px] lg:-bottom-[170px] xl:left-[330px] xl:-bottom-[325px] xxl:left-[360px] xxl:-bottom-[324px] lg:xl:text-[24px] xl:text-[40px] xxl:text-[50px]">Roadmap</h4>
                 </div>
            ...
            <div className="company-timeline-year">
                ...
                <span className="timeline-date">
                 ...
                 <span className="timeline-date">
                     <div className="date"><span className="date relative"><span className="date2 z-10 relative font-semibold text-white lg:text-2xl xl:text-4xl !leading-[4rem]">December</span><div className="absolute top-0 bottom-0 left-0 right-0 z-0"></div></span></div><span className="circle"></span>
                </span>
             </div>
    </div>
      <div className="company-timeline-slider lg:pt-[50px] xl:pt-[250px] xxl:pt-[310px] lg:pl-[160px] xl:pl-[170px] xxl:pl-[180px]">
