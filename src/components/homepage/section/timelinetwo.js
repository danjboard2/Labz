      ...
      <section className="company-timeline two" id="company-timeline">
          <div className="contain">
            ...
            <div className="timeline-heading overflow-x-clip">
                  <h2 className="year-2022 lg:text-[350px] xl:text-[550px] xxl:text-[674px] lg:-mt-[50px] xl:-mt-[74px] xxl:-mt-[90px] leading-[1] ml-[1000px] text-black -mb-[450px] font-extrabold">2022</h2>
                  <h4 className="roadmap lg:left-[310px] lg:-bottom-[245px] xl:left-[330px] xl:-bottom-[350px] xxl:left-[360px] xxl:-bottom-[324px] lg:xl:text-[24px] xl:text-[40px] xxl:text-[50px]">Roadmap</h4>
                 </div>
              <div className="company-timeline-list">
            <div className="company-timeline-year">
                <span className="timeline-date">
                    <div className="date"><span className="date relative"><span className="date2 z-10 relative font-semibold text-black lg:text-2xl xl:text-4xl !leading-[4rem]">January</span><div className="absolute top-0 bottom-0 left-0 right-0 z-0"></div></span></div><span className="circle"></span>
                </span>
                <span className="timeline-date">
                    <div className="date"><span className="date relative"><span className="date2 z-10 relative font-semibold text-black lg:text-2xl xl:text-4xl !leading-[4rem]">March</span><div className="absolute top-0 bottom-0 left-0 right-0 z-0"></div></span></div><span className="circle"></span>
                </span>
                <span className="timeline-date">
                    <div className="date"><span className="date relative"><span className="date2 z-10 relative font-semibold text-black lg:text-2xl xl:text-4xl !leading-[4rem]">June</span><div className="absolute top-0 bottom-0 left-0 right-0 z-0"></div></span></div><span className="circle"></span>
                 </span>
                 <span className="timeline-date">
                     <div className="date"><span className="date relative"><span className="date2 z-10 relative font-semibold text-black lg:text-2xl xl:text-4xl !leading-[4rem]">August</span><div className="absolute top-0 bottom-0 left-0 right z-0"></div></span></div><span className="circle"></span>
                 </span>
                 <span className="timeline-date">
                     <div className="date"><span className="date relative"><span className="date2 z-10 relative font-semibold text-black lg:text-2xl xl:text-4xl !leading-[4rem]">December</span><div className="absolute top-0 bottom-0 left-0 right-0z-0"></div></span></div><span className="circle"></span>
                </span>
             </div>
    </div>
      <div className="company-timeline-slider lg:pt-[130px] xl:pt-[250px] xxl:pt-[310px] lg:pl-[160px] xl:pl-[170px] xxl:pl-[180px]">
        <div className="company-timeline-block active"><div className="block-inner"><span className="timeline-date">January</span><span className="circle"></span><h4 className="text-black xl:text-3xl xxl:text-4xl font-bold">The Labz team formed.</h4><p className="text-black text-xl">Although small we used our 10+ yrs blockchain experience to navigate this promising landscape with opportunity and knowledge to gain at each turn.</p></div></div>
