...
export default function TimelineAnimsTwo() {
  ...
  return (
          <>
      <section className="company-timeline two !pt-[100px] md:!pt-0" id="company-timeline">
          <div className="contain">
            <div className="company-timeline-wrapper">
            <div className="timeline-heading overflow-x-clip">
                  <h2 className="year-2022 text-[140px] sm:text-[190px]  md:text-[280px] lg:text-[350px] xl:text-[550px] xxl:text-[674px] -mt-[119px] sm:-mt-[125px] md:-mt-[38px] lg:-mt-[50px] xl:-mt-[74px] xxl:-mt-[90px] leading-[1] ml-[1000px] text-black -mb-[450px] font-extrabold">2022</h2>
                  <h4 className="roadmap left-[32px] -bottom-[9px] sm:left-[68px] sm:-bottom-[42px] md:left-[180px] md:-bottom-[200px] lg:left-[310px] lg:-bottom-[245px] xl:left-[330px] xl:-bottom-[350px] xxl:left-[360px] xxl:-bottom-[324px] text-[14px] sm:text-[16px] md:text-[20px] lg:xl:text-[24px] xl:text-[40px] xxl:text-[50px]">Roadmap</h4>
                 </div>
              <div className="company-timeline-list">
              <div className="company-timeline-year">
                <span className="timeline-date">
                    <div className="date"><span className="date relative"><span className="date2 z-10 relative font-semibold text-black text-base sm:text-xl md:text-2xl xl:text-4xl !leading-[4rem]">Jan<span className="hidden lg:inline">uary</span></span><div className="absolute top-0 bottom-0 left-0 right-0 z-0"></div></span></div><span className="circle !top-[61%] lg:!top-[63.5%]"></span>
                </span>
                <span className="timeline-date">
                    <div className="date"><span className="date relative"><span className="date2 z-10 relative font-semibold text-black text-base sm:text-xl md:text-2xl xl:text-4xl !leading-[4rem]">Mar<span className="hidden lg:inline">ch</span></span><div className="absolute top-0 bottom-0 left-0 right-0 z-0"></div></span></div><span className="circle !top-[61%] lg:!top-[63.5%]"></span>
                </span>
                <span className="timeline-date">
                    <div className="date"><span className="date relative"><span className="date2 z-10 relative font-semibold text-black text-base sm:text-xl md:text-2xl xl:text-4xl !leading-[4rem]">Jun<span className="hidden lg:inline">e</span></span><div className="absolute top-0 bottom-0 left-0 right-0 z-0"></div></span></div><span className="circle !top-[61%] lg:!top-[63.5%]"></span>
                 </span>
                 <span className="timeline-date">
                     <div className="date"><span className="date relative"><span className="date2 z-10 relative font-semibold text-black text-base sm:text-xl md:text-2xl xl:text-4xl !leading-[4rem]">Aug<span className="hidden lg:inline">ust</span></span><div className="absolute top-0 bottom-0 left-0 right z-0"></div></span></div><span className="circle !top-[61%] lg:!top-[63.5%]"></span>
                 </span>
                 <span className="timeline-date">
                     <div className="date"><span className="date relative"><span className="date2 z-10 relative font-semibold text-black text-base sm:text-xl md:text-2xl xl:text-4xl !leading-[4rem]">Dec<span className="hidden lg:inline">ember</span></span><div className="absolute top-0 bottom-0 left-0 right-0 z-0"></div></span></div><span className="circle !top-[61%] lg:!top-[63.5%]"></span>
                </span>
             </div>
    </div>
      <div className="company-timeline-slider pl-[30px] sm:pl-[40px] md:pl-[60px] sm:pt-[0px] md:pt-[90px] lg:pt-[130px] xl:pt-[250px] xxl:pt-[310px] lg:pl-[160px] xl:pl-[170px] xxl:pl-[180px]">
