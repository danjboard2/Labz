  ...
  return (
   ...
   <div className="wwd-content sm:justify-center flex-col sm:flex-row w-full h-full flex overflow-hidden">
      ...
      <div className="ml-[20px] sm:ml-[40px] md:ml-[93px] pt-4 sm:pt-16 relative w-[95%] sm:w-4/5">
        <h3 className={`wwd-changing-text text-white font-bold text-2xl md:text-3xl xxl:text-4xl ${isFading ? "fade-out" : "fade-in"}`}>{dataOneValue}</h3>
      ...
      <div className="w-full mt-2 lg:mt-6 sm:mt-0 sm:w-1/3 md:w-1/2 flex flex-col  justify-center">
         ...
         <div className={`icon-wrap cursor-pointer rounded-[5.73px] w-[33%] h-[100px] sm:w-[80%] sm:h-[110px]  md:w-[40%] md:h-[130px] lg:w-[130px] lg:h-[130px] md:mb-[103px] lg:ml-[30px] lg:mr-[40px] xl:mr-[103px] flex relative`}><div data-one="Title three" data-two="Morbi vitae tellus a magna gravida vestibulum. Suspendisse mattis elementum nulla sed consectetur. Praesent consequat tempus est, vel pellentesque magna bibendum a. Sed aliquet velit ut velit rutrum feugiat. Duis non vestibulum felis. Pellentesque ultrices iaculis leo, ac blandit ipsum facilisis at." className={`icon c  w-[70px] h-[72px] md:w-[70px] md:h-[72px] lg:w-[100px] lg:h-[102.67px]  xl:w-[126.8px] xl:h-[130.67px] border-[4px] md:border-[5px] xl:border-[7.88px] border-[#FF3D00] rounded-[5.73px] absolute z-10 flex justify-center ${activeElement === 'c' ? 'active' : '' }`} onClick={() => handleClick('c')}><Image src="/media/images/wwd-icons/icon-se.svg" width={66} height={66} alt="Services" className="w-3/4"/></div></div>
            ...
            <div className={`icon-wrap cursor-pointer rounded-[5.73px] w-[33%] h-[100px] sm:w-[80%] sm:h-[110px]  md:w-[40%] md:h-[130px] lg:w-[130px] lg:h-[130px] md:mb-[103px] lg:ml-[30px] lg:mr-[40px] xl:mr-[103px]  flex relative`}><div data-one="Title six" data-two="Suspendisse eleifend est lacus, quis venenatis eros dapibus sit amet. Aenean lorem massa, facilisis eget urna eu, vestibulum porttitor mi. Nam enim augue, tempus a mollis in, interdum vel augue." className={`icon f w-[70px] h-[72px] md:w-[70px] md:h-[72px] lg:w-[100px] lg:h-[102.67px]  xl:w-[126.8px] xl:h-[130.67px] border-[4px] md:border-[5px] border-[#FF3D00] rounded-[5.73px] xl:border-[7.88px] absolute z-10 flex justify-center ${activeElement === 'f' ? 'active' : '' }`} onClick={() => handleClick('f')}><Image src="/media/images/wwd-icons/icon-co.svg" width={86} height={46} alt="Co" className="w-3/4"/></div></div>
                 <button onClick={resetChildPositions} className={`z-10 mb-20 w-full justify-end flex mr-10 button-fade ${isCompleted ? 'button-visible' : ''} ${isAnimating ? 'button-active' : ''}`}>Arrange{isAnimating ? '' : 'd'} for OCD</button>
         </div>
      </div>
    </div>
    </>
