  ...
  return (
   ...
   <div className="wwd-content w-full h-full flex overflow-hidden">
      ...
      <div className="sm:ml-[40px] md:ml-[93px] pt-16 relative w-4/5">
        ...
        <p className={`wwd-changing-text text-white sm:text-base lg:text-xl pt-4 leading-[168.5%] md:min-h-[250px] ${isFading ? "fade-out" : "fade-in"}`}>{dataTwoValue}</p>
      </div>
      </div>
      <div className="w-1/3 md:w-1/2 flex flex-col  justify-center">
         <div className="wwd-buttons flex flex-row sm:pl-[25%] md:pl-[20%] !flex-wrap lg:pl-[110px] sm:pt-[0px] md:pt-[256px] w-full lg:min-w-[520px] max-w-[900px]">
