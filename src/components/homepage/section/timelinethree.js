...
export default function TimelineAnimsThree() {
  ...
  return (
      ...
      <section className="company-timeline three" id="company-timeline">
          <div className="contain">
            ...
            <div className="timeline-heading overflow-x-clip">
                  <h2 className="year-2023 md:text-[280px] lg:text-[350px] xl:text-[550px] xxl:text-[674px] lg:-mt-[45px] xl:-mt-[72px] xxl:-mt-[88px] leading-[1] ml-[1000px] text-[#FF3D00] -mb-[450px] font-extrabold">2023</h2>
                  <h4 className="roadmap lg:left-[310px] lg:-bottom-[248px] xl:left-[330px] xl:-bottom-[350px] xxl:left-[360px] xxl:-bottom-[324px] lg:xl:text-[24px] xl:text-[40px] xxl:text-[50px]">Roadmap</h4>
                 </div>
      ...
      <div className="company-timeline-slider md:pl-[60px] md:pt-[140px]  lg:pt-[150px] xl:pt-[250px] xxl:pt-[310px] lg:pl-[160px] xl:pl-[170px] xxl:pl-[180px]">
